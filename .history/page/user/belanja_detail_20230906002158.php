...
<div class="container mt-5">
  <div class="row mb-5">
    ...
    <div class="col ms-3">
      ...
      <div class="d-flex align-items-center">
        ...
        <select name="ukuran" class="form-control w-50">
      ...
      <div class="d-flex align-items-center pt-3">
        <div class="p-2 w-25">Qty :</div>
        <input type="number" name="qty" class="form-control w-50" value="1">
      </div>
    </div>
  </div>
  ...
  <div class="row p-3">
      <div class="col ">
        ...
        <div class="">
          <textarea name="alamat_pesan" class="form-control"></textarea>
        </div>
      </div>
  </div>
  <div class="row p-3">
...
<div class="col d-flex">     
  ...
  <div>
      ...
      <input type="number" name="bayar" class="form-control" value="1" hidden>
  </div>
</div>
</div>
