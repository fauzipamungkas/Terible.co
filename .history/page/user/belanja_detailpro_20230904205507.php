...
<?php
    ...
    try {
      ...
      $pdo = $conn->prepare('INSERT INTO tbl_keranjang (id_user, id_barang, ukuran, qty, kurir, date_in, total, alamat_pesan)
                  values (:id_user, :id_barang, :ukuran, :qty, :kurir, :date_in, :total, :alamat_pesan)');
      $insertdata = array(':id_user' => $iduser, ':id_barang' => $idbarang, ':ukuran' => $ukuran, 'qty' => $qty, 'kurir' => $kurir, ':date_in' => $date, ':total' => $total, ':alamat_pesan'=>$alamat);
