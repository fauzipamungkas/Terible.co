...
$query = $conn->prepare("SELECT id,deskripsi,harga,ukuran,qty,kurir,total,alamat
                        FROM tbl_keranjang
  ...
  <table class="news">
    ...
    foreach ($data as $value): ?>
        <tr align="center">
            ...
            <td class="truncate"><?php echo $value['deskripsi'] ?></td>
    ...
    <?php if ($count > 0) { ?>
     <tr>
       <td colspan="9">Anda dapat <b>menghapus</b> barang dalam keranjang jika ada perubahan. jika tidak ada perubahan lagi,
