...
// code by muh iriansyah putra pratama
    ...
    try {
      ...
      $insert = $conn->prepare("INSERT INTO tbl_pesanan (id_user,id_barang,ukuran,qty,kurir,date_in,total,alamat_pesan,bukti) SELECT id_user,id_barang,ukuran,qty,kurir,date_in,total,alamat_pesan FROM tbl_keranjang WHERE id_user=:id");
