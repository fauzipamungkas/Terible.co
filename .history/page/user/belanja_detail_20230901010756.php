...
<div class="container">
  <div class="row">
    <div class="col d-flex justify-content-center align-center border">
    <?php
      if ($sisa > 0){
    ...
    <?php }} ?>
      ...
      <img src="img/jersey/<?php echo $row->nama_image ?>" width="30%">
    </div>
    <div class="col">
      <p>
