  ...
  <form name="add" method="post" action="?page=tambah_barangpro" enctype="multipart/form-data">
    ...
    <div class="article">
      ...
      <div class="d-flex p-3">
        ...
        <div>
          <input type="text" name="nama_barang" class="form-control" placeholder="ex: jersey barcelona away" required>
        </div>
      </div>
      <div class="d-flex p-3">
        <div class="w-25">Deskripsi Barang</div>
        <div>
          <input type="text" name="deskripsi" class="form-control" placeholder="ex: bahan terbuat dari...." required>
        </div>
      </div>
      <div class="d-flex p-3">
