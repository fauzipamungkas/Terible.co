  ...
  <table class="news">
    ...
    foreach ($data as $value): ?>
        <tr>
            ...
            <td>
              <a class="btn btn-primary" href="?page=edit_barang&id=<?php echo $value['id_barang']; ?>">ubah</a><br><br>
              <a class="btn btn-danger" href="?page=hapus_barang&id=<?php echo $value['id_barang']; ?>">hapus</a>
            </td>
        </tr>
