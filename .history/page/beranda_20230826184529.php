  ...
  foreach ($data as $value) { ?>
      ...
      <div class="col-3 d-flex justify-content-center">
        <div class="card shadow" style="width: 18rem;">
          <img src="img/jersey/<?php echo $value['nama_image']; ?>" class="card-img-top w-50 mx-auto my-auto" alt="...">
            <div class="card-body">
            ...
            if ($sisa > 0){
              if (isset ($_SESSION['username']) != ""){ ?>
                <a href="?page=belanja_detail&id=<?php echo $value['id_barang']; ?>&st=<?php echo $sisa; ?>" class="btn btn-primary">Masukkan Keranjang</a>
                <?php }} ?>
          </div>
        </div>
      </div>
